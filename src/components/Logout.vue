<template>
  <button @click="handleLogout" class="focus:outline-none flex items-center">
    <svg width="24" height="24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="mr-[-1px]">
